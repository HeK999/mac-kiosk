...
`kiosk` opens an interactive setup and management menu. The setup stores its configuration in `~/Library/Application Support/kiosk/config.json` and installs a LaunchAgent that starts `kiosk run` at login.
